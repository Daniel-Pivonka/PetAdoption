package com.example.scott.databasepets.contentprovider;
...
import com.example.scott.databasepets.Pets;
...
public class MyFavoritesContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.scott.databasepets.contentprovider";
